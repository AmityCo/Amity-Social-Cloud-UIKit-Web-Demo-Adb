...
type UISearchPostHeaderProps = ReturnType<typeof usePostHeaderProps>;

const UISearchPostHeader = ({
  avatarFileUrl,
  postAuthorName,
  postTargetName,
  timeAgo,
  ...
  loading,
  isBanned,
}: UISearchPostHeaderProps) => {
  const CustomComponentFn = useCustomComponent<UISearchPostHeaderProps>('UISearchPostHeader');
...
export default UISearchPostHeader;
